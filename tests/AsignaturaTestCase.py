...
class AsignaturaTestCase ( unittest.TestCase ) :
    ...
    def test_agregar_equipo ( self ) :
        resultado = self.sorteo.agregar_equipo( denominacionEquipo = "Equipo03" )
        self.assertEqual(resultado, True)
    ...
    def test_agregar_actividad ( self ) :
        resultado = self.sorteo.agregar_actividad( denominacionActividad = "Examen Final" , fecha = datetime ( 2021 , 10 , 20 , 00 , 00 , 00 , 00000 ) )
        self.assertEqual(resultado, True)
